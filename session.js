...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "ANJU-XPRO~nVtQUAjb#pMNNtPi9ek95OcmSdQbTu8aZCWuPLM-5k8WNgA8A8gs",
    GITHUB_TOKEN: process.env.GITHUB_TOKEN || "github token without ghp_",
    GITHUB_USERNAME: process.env.GITHUB_USERNAME || "𒋲⍣𝐘𝐀𝐌𝐈✮⃝☠️",
